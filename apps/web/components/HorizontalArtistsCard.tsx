...
function HorizontalArtistCard({
  ...
  // Verificar si artist.avatar.color está definido, sino usar negro por defecto
  ...
  return (
    <div className="mr-4 cursor-pointer" onClick={onClick}>
      ...
      >
        <div
          style={{
            background: shadeColor(avatarColor, -40), // Usar avatarColor aquí
            boxShadow:
        ...
        >
          <CustomImage
            src={artist.avatar.url} className="rounded-full"
          />
        </div>
